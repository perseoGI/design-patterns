...
public:
    ...
    static PrinterPtr getInstance() { return std::shared_ptr<LocalPrinter>{new LocalPrinter{}}; }
};
...
public:
    ...
    static PrinterPtr getInstance() { return std::shared_ptr<HttpPrinter>{new HttpPrinter{}}; }
};

int main()
{
    PrinterProvider::registerPrinter("local", &LocalPrinter::getInstance);
    PrinterProvider::registerPrinter("http", &HttpPrinter::getInstance);
